        ...
        <div class="row no-gutters">
            <div class="col-10 col-sm-4 col-md-6">
                <ul class="list-group">
                    ...
                    Пол(м/ж)<input list="gend" class="list-group-item" type="text" id="gender" value="${user.gender}"
                    ...
                    Дата регистрации<input class="list-group-item" readonly type="text" id="registered"
                                           value="${user.registered}">
                    Пароль<input class="list-group-item" type="text" id="password" value="${user.password}"
                                 placeholder="Пароли надо прятать">
